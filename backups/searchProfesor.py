...
class Ui_SearchProfWindow(object):
    def setupUi(self, SearchProfWindow):
        ...
        self.search_listView_profesor = QListView(self.centralwidget)
        self.search_listView_profesor.setObjectName(u"search_listView_profesor")
        self.search_listView_profesor.setGeometry(QRect(10, 190, 811, 181))
        font = QFont()
        font.setPointSize(12)
        self.search_listView_profesor.setFont(font)
        self.search_listView_profesor.setStyleSheet(u"background-color: rgb(255, 255, 255);\n"
"border-radius:10px;\n"
...
"")
        ...
        font1.setBold(True)
        self.label_search_profesor.setFont(font1)
        ...
        font2.setBold(True)
        self.btn_listarProfesor.setFont(font2)
...
"")
        ...
        self.input_search_profesor.setFont(font3)
...
"")
        ...
        self.btn_search_profesor.setFont(font4)
...
"")
        ...
        self.label_title_profesor.setGeometry(QRect(10, 10, 811, 81))
        font5 = QFont()
        font5.setFamilies([u"Snap ITC"])
        font5.setPointSize(40)
        font5.setItalic(True)
        self.label_title_profesor.setFont(font5)
...
"color: rgba(0, 0, 0, 0.3); ")
        ...
        self.btn_back_alumno_search.setFont(font4)
