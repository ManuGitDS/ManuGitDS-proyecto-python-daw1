...
"")
        ...
        font1.setBold(True)
        self.label_search_alumno.setFont(font1)
        ...
        font2.setBold(True)
        self.btn_listarAlumno.setFont(font2)
...
"")
        ...
        self.label_title_alumno.setGeometry(QRect(20, 30, 811, 81))
        font3 = QFont()
        font3.setFamilies([u"Snap ITC"])
        font3.setPointSize(42)
        font3.setItalic(True)
        self.label_title_alumno.setFont(font3)
...
"color: rgba(0, 0, 0, 0.3); ")
        ...
        self.btn_search_alumno.setFont(font4)
...
"}\n"
"")
        self.search_listView_alumno = QTableView(self.centralwidget)
        self.search_listView_alumno.setObjectName(u"search_listView_alumno")
        self.search_listView_alumno.setGeometry(QRect(20, 170, 801, 191))
...
"}")
    ...
    def retranslateUi(self, SearchAlumnoWindow):
        ...
        self.label_userOn.setText(QCoreApplication.translate("SearchAlumnoWindow", u"Usuario:", None))
    # retranslateUi
